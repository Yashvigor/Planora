                                        ...
                                        <div className="flex space-x-2">
                                            {land.auction_status ? (
                                                <div className={`px-3 py-1 rounded text-[10px] font-bold uppercase tracking-wider flex flex-col items-end ${
                                                    ...
                                                    <span>{land.auction_status === 'pending_verification' ? 'Auction Pending' : 
                                                     land.auction_status === 'active' ? 'Auction Live' : 'Auction Rejected'}</span>
                                                    {land.auction_status === 'active' && land.current_highest_bid && (
                                                        <span className="text-[9px] font-black text-green-700 mt-0.5">High: ₹{parseFloat(land.current_highest_bid).toLocaleString()}</span>
                                                    )}
                                                </div>
                                            ) : (
                                                <button
