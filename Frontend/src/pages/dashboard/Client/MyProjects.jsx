                    ...
                    <div className="p-8">
                        {step === 1 && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                                ...
                                <div>
                                    ...
                                    {lands.filter(l => l.verification_status === 'Verified').length === 0 ? (
                                        <div className="p-4 bg-orange-50 text-orange-700 border border-orange-200 rounded-lg text-sm mb-2">
                                            <strong>No Verified Lands Available.</strong> You must have a verified land to create a project. Please create a land in the "My Lands" tab and wait for Admin verification.
                                        </div>
                                    ) : (
                                        <select
                                            className="w-full p-3 border rounded-lg outline-none focus:ring-2 focus:ring-blue-500"
                                        ...
                                        >
                                            ...
                                            {lands.filter(l => l.verification_status === 'Verified').map(l => (
                        ...
                        {step === 2 && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                                ...
                                <div>
                                    <label className="block font-medium text-gray-700 mb-2">Project Vision / Site Description</label>
                                    <textarea
                                        className="w-full p-3 border rounded-lg h-32 outline-none focus:ring-2 focus:ring-blue-500"
                                        placeholder="Describe your vision for this property..."
